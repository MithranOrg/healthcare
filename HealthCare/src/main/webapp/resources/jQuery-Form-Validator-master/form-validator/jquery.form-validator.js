 ...
 */ (function($) {
    ...
    $.fn.validateInputOnBlur = function(language, conf, attachKeyupEvent, eventType) {
        ...
        var $elem = this,
            ...
            $elem, language, conf, //$.extend({}, conf, {errorMessagePosition: 'element'}),
            $form, eventType);
    ...
    $.fn.isValid = function(language, conf, displayError) {
        ...
        $form.find('input,textarea,select').filter(':not([type="submit"],[type="button"])').each(function() {
            ...
            if (!ignoreInput(elementName, elementType) && (!isCheckboxOrRadioBtn || $.inArray(elementName, checkedInputs) < 0)) {
                ...
                $elem, language, conf, $form, 'submit');
    ...
    $.formUtils = {
        ...
        defaultConfig: function() {
            return {
                ignore: [],
                // Names of inputs not to be validated even though node attribute containing the validation rules tells us to
        ...
        LANG: {
            ...
            requiredFields: 'You have not answered required field',
   ...
   * * * * * * * * * * * * * * * * * * * * */
        ...
        validatorFunction: function(val, $el, conf) {
            if (val !== '') {
                var allowing = $el.valAttr('allowing') || '',
                    ...
                    allowsRange = false,
                    begin, end, steps = $el.valAttr('step') || '',
                    allowsSteps = false;
    ...
    $.formUtils.addValidator({
        ...
        validatorFunction: function(val, $el, conf, lang, $form) {
            ...
            // Custom validations - changed by Madhankumar S
            /*
             * Validate alphabets
             */
            $.formUtils.addValidator({
                name: 'customalphabets',
                validatorFunction: function(val, $el, conf, language) {
